...
"")
        ...
        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.std_class_box)
...
"")
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.std_section_box)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Student Attendance", None))
        ...
        ___qtablewidgetitem = self.std_attend_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"Standard", None));
        ___qtablewidgetitem1 = self.std_attend_table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"Division", None));
        ___qtablewidgetitem2 = self.std_attend_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Date", None));
        ___qtablewidgetitem3 = self.std_attend_table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Student ID", None));
        ___qtablewidgetitem4 = self.std_attend_table.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"Student Name", None));
        ___qtablewidgetitem5 = self.std_attend_table.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MainWindow", u"Attendance", None));
        self.fetch_btn.setText(QCoreApplication.translate("MainWindow", u"Fetch Attendance", None))
        self.save_btn.setText(QCoreApplication.translate("MainWindow", u"Save Attendance", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("MainWindow", u"Student Attendance", None))
    # retranslateUi
