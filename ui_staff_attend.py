...
"")
        ...
        self.staff_attend_table = QTableWidget(self.tab)
...
"")
        ...
        self.horizontalLayout_4.addWidget(self.staff_calender_box, 0, Qt.AlignRight)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Staff Attendance", None))
        ...
        ___qtablewidgetitem = self.staff_attend_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"Staff ID", None));
        ___qtablewidgetitem1 = self.staff_attend_table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"Staff Role", None));
        ___qtablewidgetitem2 = self.staff_attend_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Staff Name", None));
        ___qtablewidgetitem3 = self.staff_attend_table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Date", None));
        ___qtablewidgetitem4 = self.staff_attend_table.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"Attendance", None));
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("MainWindow", u"Staff Attendance", None))
    # retranslateUi
