...
"font: 700 14pt \"Segoe UI\";")
        ...
        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.std_id_label)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.std_firstname_box)
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.std_lastname_box)
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.std_fname_box)
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.std_mname_box)
...
"")
        ...
        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.std_gender_box)
        ...
        self.formLayout.setWidget(7, QFormLayout.FieldRole, self.std_dob_box)
...
"")
        ...
        self.admission_table = QTableWidget(self.tab)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Admission Page", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Student ID", None))
        self.std_id_label.setText(QCoreApplication.translate("MainWindow", u"RG-1209", None))
        ...
        ___qtablewidgetitem = self.admission_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"Student ID", None));
        ___qtablewidgetitem1 = self.admission_table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"Standard", None));
        ___qtablewidgetitem2 = self.admission_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Division", None));
        ___qtablewidgetitem3 = self.admission_table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Student Name", None));
        ___qtablewidgetitem4 = self.admission_table.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"Gender", None));
        ___qtablewidgetitem5 = self.admission_table.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MainWindow", u"DOB", None));
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("MainWindow", u"Enter Student Details", None))
    # retranslateUi
